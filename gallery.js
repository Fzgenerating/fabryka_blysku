...
const GALLERY_PLACEHOLDER = "assets/img/gallery/placeholder.svg";
...
async function resolveImages() {
    ...
    // Fallback: placeholder, gdy w repo brak binarnych grafik
...
function buildPlaceholderEntry() {
    return {
        ...
        alt: "Dodaj zdjęcia do folderu assets/img/gallery",
        label: "Oczekiwanie na zdjęcia"
    };
}
